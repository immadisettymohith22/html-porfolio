...
<div style="text-align:center; padding: 2rem;">
    ...
    <h1 class="title" style="font-size: 2.2rem; margin-top: 2rem;">Academic Campus Event & Registration Portal</h1>
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-card">
            ...
            <a href="student_login.php" class="btn" style="width: 100%; background: var(--primary);">Enter Student Portal</a>
        </div>

        <div class="dashboard-card">
            <img src="admin_office_bg.png" class="card-bg" alt="Admin Portal Background">
